...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">ยืมหนังสือ</h4>
...
<label>รหัสนิสิต<span style="color:red;">*</span></label>
<input class="form-control" type="text" name="studentid" id="studentid" onBlur="getstudent()" autocomplete="on"  required />
</div>
...
<div class="form-group">
<label>รหัสหนังสือ<span style="color:red;">*</span></label>
...
<button type="submit" name="issue" id="submit" class="btn btn-info">ยืมหนังสือ </button>
