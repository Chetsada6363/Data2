...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">โปรไฟล์ฉัน</h4>
...
<button type="submit" name="update" class="btn btn-primary" id="submit">แก้ไข</button>
